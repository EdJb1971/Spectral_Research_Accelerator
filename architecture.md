...
| Backend test suite | **4348 passed, 1 xfailed** (plus 4 skipped: the opt-in live GCS read, opt-in live store probe, opt-in live Argo acceptance, and opt-in live TESS/MAST acceptance). Measured 2026-09-08 in 2,540.82 s (0:42:20), exit 0, on the tree carrying T4E.6. Nothing failed in this run. It is exactly 54 above the previous measurement of 4294: 29 cases from T4E.5's suite, 22 from T4E.6's, and 3 new documentation guards, so nothing was lost in between. |
