...
| `live_sources` | `NOT_RUN` | `src/core/live_source_evidence.py` finds no dated record yet. It requires three bounded archive acquisitions plus one content-addressed bespoke local record. |
