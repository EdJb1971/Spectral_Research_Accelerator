...
| Backend test suite | **3893 passed, 1 xfailed** Plus four explicit skips: the opt-in live GCS read, opt-in live store probe, opt-in live Argo acceptance, and opt-in live TESS/MAST acceptance. Measured 2026-09-05 in 3,859.63 s (1:04:19), exit 0, on the tree carrying TG17.15 slice 5. Nothing failed in this run. |
