...
| Backend test suite | **4036 passed, 1 xfailed** Plus four explicit skips: the opt-in live GCS read, opt-in live store probe, opt-in live Argo acceptance, and opt-in live TESS/MAST acceptance. Measured 2026-09-06 in 3,665.97 s (1:01:05), exit 0, on the tree carrying T4F.4. Nothing failed in this run. |
...
remains. T4D.1-3, T4E.1-4, T4F.1, T4F.2, T4F.3 and T4F.4 are complete. T4F.5-8, 4G and optional 4H remain
undone. See
