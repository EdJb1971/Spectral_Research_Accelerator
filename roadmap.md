...
| Backend test suite | **3738 passed, 1 xfailed** Plus four explicit skips: the opt-in live GCS read, opt-in live store probe, opt-in live Argo acceptance, and opt-in live TESS/MAST acceptance. Measured 2026-09-04 in 2,704.67 s (45:04), exit 0, on the tree carrying T4F.1 and TG17.14. Nothing failed in this run. |
...
remains. T4D.1-3, T4E.1-4 and T4F.1 are complete. T4F.2-8, 4G and optional 4H remain
undone. See
