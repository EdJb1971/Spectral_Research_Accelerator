...
| Backend test suite | **3926 passed, 1 xfailed** Plus four explicit skips: the opt-in live GCS read, opt-in live store probe, opt-in live Argo acceptance, and opt-in live TESS/MAST acceptance. Measured 2026-09-05 in 3,510.91 s (0:58:30), exit 0, on the tree carrying T4F.2. Nothing failed in this run. |
...
remains. T4D.1-3, T4E.1-4, T4F.1 and T4F.2 are complete. T4F.3-8, 4G and optional 4H remain
undone. See
