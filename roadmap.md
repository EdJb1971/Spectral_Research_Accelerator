...
`VERIFICATION.md`; `architecture.md` Section 7 holds the full defect ledger (D1-D92, of which **89 fixed, 1 partial (D18), 2 open (D84, D85)**).
...
remains. T4D.1-3 and T4E.1-4 are complete. 4F, 4G and optional 4H remain undone. See
