...
| Backend test suite | **3868 passed, 1 xfailed** Plus four explicit skips: the opt-in live GCS read, opt-in live store probe, opt-in live Argo acceptance, and opt-in live TESS/MAST acceptance. Measured 2026-09-05 in 2,481.74 s (41:21), exit 0, on the tree carrying TG17.15 slice 4. Nothing failed in this run. |
