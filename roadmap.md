...
| Backend test suite | **4103 passed, 1 xfailed** Plus four explicit skips: the opt-in live GCS read, opt-in live store probe, opt-in live Argo acceptance, and opt-in live TESS/MAST acceptance. Measured 2026-09-06 in 2,524.94 s (0:42:04), exit 0, on the tree carrying T4F.5. Nothing failed in this run. |
...
remains. T4D.1-3, T4E.1-4 and T4F.1-5 are complete. T4F.6-8, 4G and optional 4H remain
undone. See
