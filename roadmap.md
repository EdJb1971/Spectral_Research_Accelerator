...
`VERIFICATION.md`; `architecture.md` Section 7 holds the full defect ledger (D1-D71, of which **67 fixed, 1 partial (D18), 3 open (D43, D69, D71)**).
